...
/*
---------------------------------------------------------------------------------
File Name : UpdateAllInvites.java
...
public class UpdateAllInvites extends Task {

    private final FluffBOT instance;

    public UpdateAllInvites(FluffBOT instance) {
        this.instance = instance;

        this.instance.getLogger().debug("Loading UpdateAllInvites scheduler.");
    }
    ...
    public void execute() {
        this.instance.getScheduledExecutorService().scheduleAtFixedRate(() -> {
            try {
                this.instance.getGameServiceManager().updateExpiredInvites();
            } catch (Exception e) {
